		...
		<div className="stat-block wide">
			...
			<div className="section-left">
				...
				<div className="top-stats">
					...
					{data.languages && <PropertyLine title="Languages" value={data.languages.join(', ')} />}
			...
			<div className="section-right">
				{data.actions && <ActionList title="Actions" list={data.actions} />}
				{data.reactions && <ActionList title="Reactions" list={data.reactions} />}
				{data.legendary && <ActionList title="Legendary Actions" list={data.legendary} />}
			</div>
...
function ActionList({title, list}) {
	return (
		<div className="actions">
			<h3>{title}</h3>
			{list.map(act => (
				<PropertyBlock title={act.name} value={getAtk(act)} />
			))}
		</div>
	);
}
